-- Configuração do baú raro
local AttributesConfig = dofile('data/libs/systems/attributes_config.lua')

local CHEST_CONFIG = {
    id = 7623,  -- ID do baú trancado
    openedId = 7624, -- ID do baú aberto
    name = "Rare chest",
    unlockTime = 8, -- Tempo em segundos para destravar
    effect = 178, -- Efeito durante o desbloqueio
    successEffect = 174, -- Efeito de sucesso ao abrir
    minItems = 2,  -- Mínimo de itens por baú
    maxItems = 4,  -- Máximo de itens por baú
    items = {
